...
public class GlobalDef {
    ...
    public static final int LENGTH_COLOR = Color.GREEN.getRGB();
    public static final int WIDTH_COLOR = Color.BLUE.getRGB();
    public static final int DEEP_COLOR = Color.RED.getRGB();
    public static final int FOCUS_BACK_COLOR = Color.YELLOW.getRGB();

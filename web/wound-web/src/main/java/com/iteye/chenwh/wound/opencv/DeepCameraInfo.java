...
public class DeepCameraInfo {
    ...
    private transient Image rgbBitmap;
    private transient Image PdfBitmap;
    ...
    public void setRgbBitmap(Image rgbBitmap) {
        this.rgbBitmap = rgbBitmap;
    }

    public Image getPdfBitmap() {
        return PdfBitmap;
    }

    public void setPdfBitmap(Image pdfBitmap) {
        PdfBitmap = pdfBitmap;
    }
